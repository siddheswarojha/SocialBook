...
//
//
//    public HomeRecylerAdapter( ArrayList<productModel> list) {
//        this.list = list;
//    }
//
//    @NonNull
...
//
//holder.postDetails.setText(list.get(position).getData());
//
//int x = list.get(position).getLike();
//
//        holder.txtLikeCount.setText(String.valueOf(x));
//
//    }
//
//    @Override
